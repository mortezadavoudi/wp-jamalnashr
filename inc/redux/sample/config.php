...
$opt_name = 'jamal_option';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
    ...
    'menu_title'                => esc_html__( ' تنظیمات قالب جمال', 'your-textdomain-here' ),

    // The text to appear on the page title.
    'page_title'                => esc_html__( 'تنظیمات قالب', 'your-textdomain-here' ),
    ...
    'admin_bar_priority'        => 3,

    // Sets a different name for your global variable other than the opt_name.
    'global_variable'           => 'jamal_admin',
...
$args['footer_text'] = '<p>' . esc_html__( 'طراحی شده توسط نوین پروا . مرتضی داودی', 'your-textdomain-here' ) . '</p>';
...
Redux::set_section($opt_name,array(
    'title' => __('تنظیمات عمومی','jamal'),
    'id' => 'general',
    'desc' => __('','jamal'),
    'icon' => '',
    'fields' => array(
        array(
            'id' => 'opt-color-general',
            'type' => 'color',
            'title' => __('رنگ اصلی','jamal'),
            'subtitle' => 'رنگ دکمه ها، هدر، قیمت ها، و ...',
            'default'  => '#75e0c4',
            'validate' => 'color',
        ),
        array(
            'id' => 'opt-color-shadow',
            'type' => 'color',
            'title' => __('رنگ سایه','jamal'),
            'subtitle' => 'رنگ سایه های دکمه ها، هدر، قیمت ها، و ...',
            'default'  => '#20cda2',
            'validate' => 'color',
        ),
        array(
            ...
            'type' => 'color',
            'title' => __('رنگ ثانویه','jamal'),
            'subtitle' => 'بک گراند هدر، باکس ها، دکمه های ثانویه و ...',
            'default'  => '#eef4f4',
            'validate' => 'color',
        ),
        array(
            'id' => 'opt-color-secondary',
            'type' => 'color',
            'title' => __('رنگ تخفیف ها و اعلان ها','jamal'),
            'subtitle' => 'اعلان ها و بادگت ها و ...',
            'default'  => '#ff1e1e',
            'validate' => 'color',
        ),
        array(
            'id' => 'opt-compare',
            'type' => 'switch',
            'title' => __('فعال سازی مقایسه','jamal'),
            'default' => true,
            'on' => 'روشن',
            'off' => 'خاموش',
        ),
        array(
            'id' => 'opt-qview',
            'type' => 'switch',
            'title' => __('فعال سازی نمایش سریع محصول','jamal'),
            'default' => false,
            'on' => 'نمایش',
            'off' => 'عدم نمایش',
        ),
...
Redux::set_section($opt_name,array(
    'title' => __('سربرگ','jamal'),
    'id' => 'header',
    'desc' => __('تنطیمات هدر','jamal'),
    ...
    'fields' => array(
        array(
            ...
            'type' => 'media',
            'title' => __('لوگو','jamal'),
            'subtitle' => 'انتخاب لوگوی هدر',
        ),
        array(
            'id' => 'opt-favicon',
            'type' => 'media',
            'title' => __('فاو آیکن','jamal'),
            'subtitle' => 'Favicon',
        ),
        array(
            'id' => 'opt-instagram',
            'type' => 'text',
            'title' => __('اینستاگرام','jamal'),
            'subtitle' => 'instagram link',
        ),
        array(
            'id' => 'opt-phone',
            'type' => 'text',
            'title' => __('شماره تماس','jamal'),
...
Redux::set_section($opt_name,array(
    'title' => __('صفحات','jamal'),
    'id' => 'pages',
    'submenu' => true,
    'desc' => __('تنظیمات صفحات','jamal'),
    'icon' => 'el el-check-empty',
    'fields' => array(
        array(
            'id' => 'opt-pages',
            'type' => 'image_select',
            'title' => __('موقعیت سایدبار','jamal'),
...
Redux::set_section($opt_name,array(
    'title' => __('صفحه سبد خرید','jamal'),
    'id' => 'cart',
    'subsection' => true,
    'menu_type' => 'submenu',
    'desc' => __('پیام های سبد خرید','jamal'),
    'icon' => 'el el-check-empty',
    'fields' => array(
        array(
            'id' => 'opt-cart',
            'type' => 'multi_text',
            'title' => __('پیام های بالای سبد خرید','jamal'),
        )
    ),
));
Redux::set_section($opt_name,array(
    'title' => __('بنر های صفحه اصلی','jamal'),
    'id' => 'baners',
    'subsection' => true,
    'menu_type' => 'submenu',
    'desc' => __('تنظیمات بنر های صفحه نخست','jamal'),
    'icon' => 'el el-check-empty',
    'fields' => array(
        array(
            'id' => 'opt-banner1',
            'type' => 'media',
            'title' => __('تصویر بنر بزرگ وسط ','jamal'),
        ),
        array(
            'id' => 'opt-banner1_link',
            'type' => 'text',
            'title' => __('لینک بنر بزرگ وسط','jamal'),
            'indent' => true
        ),
        array(
            'id' => 'opt-banner2',
            'type' => 'media',
            'title' => __('تصویر بنر کوچک سمت راست','jamal'),
        ),
        array(
            'id' => 'opt-banner2_link',
            'type' => 'text',
            'title' => __('لینک بنر کوچک سمت راست','jamal'),
        ),
        array(
            'id' => 'opt-banner3',
            'type' => 'media',
            'title' => __('تصویر بنر کوچک سمت چپ','jamal'),
        ),
        array(
            'id' => 'opt-banner3_link',
            'type' => 'text',
            'title' => __('لینک بنر کوچک سمت چپ','jamal'),
        ),
    ),
));
Redux::set_section($opt_name,array(
    'title' => __('پابرگ','jamal'),
    'id' => 'footer',
    'desc' => __('تنطیمات فوتر','jamal'),
    'icon' => 'el el-check-empty',
    'fields' => array(
        array(
            'id' => 'opt-footer-about',
            'type' => 'editor',
            'title' => __('درباره جمال','jamal'),
            'subtitle' => 'About Footer',
        ),
        array(
            'id' => 'opt-contact-text',
            'type' => 'text',
            'title' => __('متن تماس با ما در فوتر','jamal'),
        ...
        array(
            'id' => 'opt-crtpersian',
            'type' => 'text',
            'title' => __('کپی رایت فارسی','jamal'),
            'subtitle' => 'Copy Right Text',
        ),
        array(
            'id' => 'opt-crt',
            'type' => 'text',
            'title' => __('کپی رایت','jamal'),
            'subtitle' => 'Copy Right Text',
        ),
    )
));
Redux::setSection($opt_name,array(
    'title' => __('اسلایدر','jamal'),
    'id' => 'opt-slider',
    'desc' => __('اسلایدر صفحه نخست','jamal'),
    'icon' => 'el el-check-empty',
    'fields' => array(
        array(
            'id'          => 'opt-slides',
